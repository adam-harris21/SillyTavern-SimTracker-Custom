...
const defaultSimFields = [
  ...
  {
    key: "outfit",
    description: "Character's current outfit/clothing description",
  },
  {
    key: "position",
    description: "Character's current physical position/pose (e.g., standing, sitting, lying down)",
  },
  {
    key: "location",
    description: "Character's current location (e.g., bedroom, kitchen, park)",
  },
];
